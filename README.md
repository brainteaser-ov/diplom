...
В интерфейсе запущены две модели, *сеть 2* (дообученная модель) и *сеть 1* (первоначальная модель), при вводе пары в формате: 
```
слово:перевод
```
...
<p align="center">
  <img src="/Снимок экрана 2025-01-26 в 21.23.53.png" alt="Запущенная модель
" width="738">
</p>
